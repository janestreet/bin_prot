...
let bin_shape_float32_cube          = basetype (Uuid.of_string "float32_cube")       []
let bin_shape_float64_cube          = basetype (Uuid.of_string "float64_cube")       []
let bin_shape_cube                  = basetype (Uuid.of_string "cube")               []
