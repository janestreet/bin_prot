...
let bin_write_unit__local = Write.bin_write_unit__local
let bin_reader_unit = Type_class.bin_reader_unit
let bin_read_unit = Read.bin_read_unit

let __bin_read_unit__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_bool__local = Write.bin_write_bool__local
let bin_reader_bool = Type_class.bin_reader_bool
let bin_read_bool = Read.bin_read_bool

let __bin_read_bool__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_string__local = Write.bin_write_string__local
let bin_reader_string = Type_class.bin_reader_string
let bin_read_string = Read.bin_read_string

let __bin_read_string__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_bytes__local = Write.bin_write_bytes__local
let bin_reader_bytes = Type_class.bin_reader_bytes
let bin_read_bytes = Read.bin_read_bytes

let __bin_read_bytes__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_char__local = Write.bin_write_char__local
let bin_reader_char = Type_class.bin_reader_char
let bin_read_char = Read.bin_read_char

let __bin_read_char__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_int__local = Write.bin_write_int__local
let bin_reader_int = Type_class.bin_reader_int
let bin_read_int = Read.bin_read_int
let __bin_read_int__ ~ctx:_ _buf ~pos_ref _vint = Common.raise_variant_wrong_type "int" !pos_ref
...
let bin_write_float__local = Write.bin_write_float__local
let bin_reader_float = Type_class.bin_reader_float
let bin_read_float = Read.bin_read_float

let __bin_read_float__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_floatarray__local = Write.bin_write_floatarray__local
let bin_reader_floatarray = Type_class.bin_reader_floatarray
let bin_read_floatarray = Read.bin_read_floatarray

let __bin_read_floatarray__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_int32__local = Write.bin_write_int32__local
let bin_reader_int32 = Type_class.bin_reader_int32
let bin_read_int32 = Read.bin_read_int32

let __bin_read_int32__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_int64__local = Write.bin_write_int64__local
let bin_reader_int64 = Type_class.bin_reader_int64
let bin_read_int64 = Read.bin_read_int64

let __bin_read_int64__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_nativeint__local = Write.bin_write_nativeint__local
let bin_reader_nativeint = Type_class.bin_reader_nativeint
let bin_read_nativeint = Read.bin_read_nativeint

let __bin_read_nativeint__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_ref__local = Write.bin_write_ref__local
let bin_reader_ref = Type_class.bin_reader_ref
let bin_read_ref = Read.bin_read_ref

let __bin_read_ref__ _f ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_lazy_t__local = Write.bin_write_lazy__local
let bin_reader_lazy_t = Type_class.bin_reader_lazy
let bin_read_lazy_t = Read.bin_read_lazy

let __bin_read_lazy_t__ _f ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_lazy__local = Write.bin_write_lazy__local
let bin_reader_lazy = Type_class.bin_reader_lazy
let bin_read_lazy = Read.bin_read_lazy

let __bin_read_lazy__ _f ~ctx:_ _buf ~pos_ref _vint =
  Common.raise_variant_wrong_type "lazy" !pos_ref
;;
...
let bin_write_option__local = Write.bin_write_option__local
let bin_reader_option = Type_class.bin_reader_option
let bin_read_option = Read.bin_read_option

let __bin_read_option__ _f ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_list__local = Write.bin_write_list__local
let bin_reader_list = Type_class.bin_reader_list
let bin_read_list = Read.bin_read_list

let __bin_read_list__ _f ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_array__local = Write.bin_write_array__local
let bin_reader_array = Type_class.bin_reader_array
let bin_read_array = Read.bin_read_array

let __bin_read_array__ _f ~ctx:_ _buf ~pos_ref _vint =
...
let __bin_read_hashtbl__ _f _g ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_bigstring__local = Write.bin_write_bigstring__local
let bin_reader_bigstring = Type_class.bin_reader_bigstring
let bin_read_bigstring = Read.bin_read_bigstring

let __bin_read_bigstring__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_mat__local = Write.bin_write_mat__local
let bin_reader_mat = Type_class.bin_reader_mat
let bin_read_mat = Read.bin_read_mat
let __bin_read_mat__ ~ctx:_ _buf ~pos_ref _vint = Common.raise_variant_wrong_type "mat" !pos_ref
...
let bin_write_float32_mat__local = Write.bin_write_float32_mat__local
let bin_reader_float32_mat = Type_class.bin_reader_float32_mat
let bin_read_float32_mat = Read.bin_read_float32_mat

let __bin_read_float32_mat__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_float64_mat__local = Write.bin_write_float64_mat__local
let bin_reader_float64_mat = Type_class.bin_reader_float64_mat
let bin_read_float64_mat = Read.bin_read_float64_mat

let __bin_read_float64_mat__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_vec__local = Write.bin_write_vec__local
let bin_reader_vec = Type_class.bin_reader_vec
let bin_read_vec = Read.bin_read_vec
let __bin_read_vec__ ~ctx:_ _buf ~pos_ref _vint = Common.raise_variant_wrong_type "vec" !pos_ref
...
let bin_write_float32_vec__local = Write.bin_write_float32_vec__local
let bin_reader_float32_vec = Type_class.bin_reader_float32_vec
let bin_read_float32_vec = Read.bin_read_float32_vec

let __bin_read_float32_vec__ ~ctx:_ _buf ~pos_ref _vint =
...
let bin_write_float64_vec__local = Write.bin_write_float64_vec__local
let bin_reader_float64_vec = Type_class.bin_reader_float64_vec
let bin_read_float64_vec = Read.bin_read_float64_vec

let __bin_read_float64_vec__ ~ctx:_ _buf ~pos_ref _vint =
