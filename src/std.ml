(** This module defines default converters for the types defined in the OCaml standard
    library. *)
...
let%template[@mode m = (global, local)] bin_write_unit = (Write.bin_write_unit [@mode m])
...
let%template[@mode m = (global, local)] bin_write_bool = (Write.bin_write_bool [@mode m])
...
let%template[@mode m = (global, local)] bin_write_string =
  (Write.bin_write_string [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_bytes =
  (Write.bin_write_bytes [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_char = (Write.bin_write_char [@mode m])
...
let%template[@mode m = (global, local)] bin_write_int = (Write.bin_write_int [@mode m])
...
let%template[@mode m = (global, local)] bin_write_float =
  (Write.bin_write_float [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_floatarray =
  (Write.bin_write_floatarray [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_int32 =
  (Write.bin_write_int32 [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_int64 =
  (Write.bin_write_int64 [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_nativeint =
  (Write.bin_write_nativeint [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_ref = (Write.bin_write_ref [@mode m])
...
let%template[@mode m = (global, local)] bin_write_lazy_t =
  (Write.bin_write_lazy [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_lazy = (Write.bin_write_lazy [@mode m])
...
let%template[@mode m = (global, local)] bin_write_option =
  (Write.bin_write_option [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_list = (Write.bin_write_list [@mode m])
...
let%template[@mode m = (global, local)] bin_write_array =
  (Write.bin_write_array [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_bigstring =
  (Write.bin_write_bigstring [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_mat = (Write.bin_write_mat [@mode m])
...
let%template[@mode m = (global, local)] bin_write_float32_mat =
  (Write.bin_write_float32_mat [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_float64_mat =
  (Write.bin_write_float64_mat [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_vec = (Write.bin_write_vec [@mode m])
...
let%template[@mode m = (global, local)] bin_write_float32_vec =
  (Write.bin_write_float32_vec [@mode m])
;;
...
let%template[@mode m = (global, local)] bin_write_float64_vec =
  (Write.bin_write_float64_vec [@mode m])
;;
