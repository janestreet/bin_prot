...
external int32_to_int : (int32[@local_opt]) -> int = "%int32_to_int"
external int64_to_int : (int64[@local_opt]) -> int = "%int64_to_int"
...
external int64_of_int32 : (int32[@local_opt]) -> (int64[@local_opt]) = "%int64_of_int32"
