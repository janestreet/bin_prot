...
module Definitions = struct
  ...
  module type Make_binable1_without_uuid_spec = sig
    ...
    val to_binable : 'a t -> 'a Binable.t [@@mode m = (global, m)]
  ...
  module type Make_binable2_without_uuid_spec = sig
    ...
    val to_binable : ('a, 'b) t -> ('a, 'b) Binable.t [@@mode m = (global, m)]
  ...
  module type Make_binable3_without_uuid_spec = sig
    ...
    val to_binable : ('a, 'b, 'c) t -> ('a, 'b, 'c) Binable.t [@@mode m = (global, m)]
