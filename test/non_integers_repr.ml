...
module Vec = struct
  ...
  external dim : ('a, 'b, 'c) Array1.t -> int = "%caml_ba_dim_1"
  external kind : ('a, 'b, 'c) Array1.t -> ('a, 'b) kind = "caml_ba_kind"
  external get : ('a, 'b, 'c) Array1.t -> int -> 'a = "%caml_ba_ref_1"
...
module Mat = struct
  ...
  external dim1 : ('a, 'b, 'c) Array2.t -> int = "%caml_ba_dim_1"
  external dim2 : ('a, 'b, 'c) Array2.t -> int = "%caml_ba_dim_2"
  external kind : ('a, 'b, 'c) Array2.t -> ('a, 'b) kind = "caml_ba_kind"
  external get : ('a, 'b, 'c) Array2.t -> int -> int -> 'a = "%caml_ba_ref_2"
