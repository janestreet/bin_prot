...
(* OASIS_START *)
(* DO NOT EDIT (digest: f2b2f3aa785f3377f423d45508b67c00) *)
(*
...
let setup_t =
  {
     ...
     doc = [("bin_prot", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("bin_prot", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test_runner",
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Markus Mottl"; "Jane Street Holding LLC"];
          homepage = None;
          synopsis = "binary protocol generator";
          description = Some "binary protocol generator";
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for bin_prot";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "#\027\015\143K\130\188N\023;\007\214[\255\224\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
